...
% continuous. It requires a different construction. Lemma 17.3 of Tartar (``An
% Introduction to Sobolev Spaces'') gives a construction for m = 1 and d = 2
% based on the Hahn-Banach theorem. I should we see whether it can be extended
% to the general case. 
