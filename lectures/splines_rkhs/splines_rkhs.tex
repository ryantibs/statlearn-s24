...
$f_k \to f$ as $k \to \infty$ in \smash{$\|\cdot\|_{W^{m,2}(U)}$} norm, the
...
that: % TODO: double check what happens when 2m = d? Here an below, with respect
% to existence of solutions ...
\begin{quote}
\centering\it
