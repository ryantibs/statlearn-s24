...
in \smash{$\|\cdot\|_{W^{m,2}(U)}$} norm but $f_N(x) \not\to f(x)$ for some
...
\smash{$\|\cdot\|_{W^{m,2}(U)}$} norm. However, recall $f_N(0) = 1$ for all $N$,
...
\smash{$\|\cdot\|_{W^{m,2}(U)}$} norm, but $f_N(0) = 1$ for all $N$.  

% RJT. Credit to Alden for finding this; he found a nice and simple
% construction. See the note he sent me. Also, a log singularity is another
% possible construction; as in the proof of the second case on page 8 of El
% Alaoui et al. (2016): https://proceedings.mlr.press/v49/elalaoui16.pdf. 
