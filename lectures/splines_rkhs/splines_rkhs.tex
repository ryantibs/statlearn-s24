...
lecture on nonparametric regression. In particular, we reiterate that we
abbreviate the population and empirical $L^2$ norms based on a test sample $x_0
\sim P$ and training samples $x_1\dots,x_n \sim P_n$, respectively, by 
\[
...
Examples of kernels on $\cX = \R^d$ include:
\begin{alignat*}{3}
