...
predicted quantiles \smash{$\{q_\tau\}_{\tau \in \cT}$} is proper if it holds
that    
\begin{equation}
\label{eq:proper_q}
...
\citet{fakoor2023flexible}, which basically just fills in a few missing details.
...
adapted from Section 3 of \citet{fakoor2023flexible}.  
...
\caption{\it Densities that result from a probability average (left) or quantile
  ...
  (drawn in blue). Credit: \citet{fakoor2023flexible}.}  
...
This result is due to \citet{fakoor2023flexible}. The assumption that $f_1$ is
