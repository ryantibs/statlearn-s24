...
(ii) Simulate the 95th percentile of the supremum of the absolute Brownian
bridge, i.e., the value $q$ such that    
\[
...
\item Prove that for any $\delta$, there exists a rectangular partition
  $U_1,\dots,U_{N(\delta)}$ of $[-R,R]^d$ with diameter at most $\delta$, and  
  \marginpar{\small [4 pts]}
  \[
